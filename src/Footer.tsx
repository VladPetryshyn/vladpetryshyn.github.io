...
export const FooterSection = () => {
  return <footer className="dark:bg-dark-bg2 w-full py-3 bg-light-bg2 flex flex-col align-center justify-center rounded-t-3xl ">
    <div className="flex justify-center mb-4">
      {footer.links.map(({ icon, link }) => <a aria-label="Visit my social page" href={link} key={link}>
        <FontAwesomeIcon icon={icon} className="dark:text-dark-txt text-light-txt text-5xl mr-10" />
      </a>)}
    </div>
